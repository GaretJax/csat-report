...
\newcommand\myfiglisting{%
  \cleartoodd
  \chapter*{\hspace{15pt}List of Figures}%
  \@starttoc{lof}
}
\newcommand\mytablisting{%
  \cleartoodd
  \chapter*{\hspace{15pt}List of Tables}%
  \@starttoc{lot}
}
\newcommand\mylstlisting{%
  \cleartoodd
  \chapter*{\hspace{15pt}List of Source Code Listings}%
...
\newcommand\myalglisting{%
  \cleartoodd
  \renewcommand{\listalgorithmname}{\hspace{15pt}List of Algorithms}
  \listofalgorithms
}
